...
export const peakeesCategories: PeakeesCategory[] = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'teens-school-uniforms', name: 'School Uniforms', hebrew: 'מדי בית ספר', parentId: 'teens' },
    ],
  },
  ...
  // Additional Categories
  {
    ...
    subcategories: [
      ...
      { id: 'kids-school-uniforms', name: 'School Uniforms', hebrew: 'מדי בית ספר', parentId: 'kids' },
    ],
  },
  {
    id: 'babies',
  ...
  // Toys & Books
  {
    ...
    subcategories: [
      ...
      { id: 'educational-toys', name: 'Educational Toys', hebrew: 'צעצועים חינוכיים', parentId: 'toys' },
    ],
  },
  {
    id: 'books',

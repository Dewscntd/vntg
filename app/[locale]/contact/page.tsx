...
export const metadata: Metadata = {
  title: 'Contact Us | Peakees - Get in Touch',
  description:
    'Contact Peakees for customer support, inquiries, or assistance. Email, phone, and business address information available.',
  keywords: 'Peakees, contact, customer support, help, email, phone',
  openGraph: {
    title: "Contact Peakees - We're Here to Help",
        ...
        >
          <Card>
            ...
            <CardContent>
              ...
              <a
                href="mailto:support@peakees.com"
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-1">
                <p className="font-medium">Peakees E-commerce</p>

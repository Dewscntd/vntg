...
# HELP peakees_database_connection_status Database connection status (1 = up, 0 = down)
# TYPE peakees_database_connection_status gauge
peakees_database_connection_status ${dbStatus}

# HELP peakees_database_response_time_ms Database response time in milliseconds
# TYPE peakees_database_response_time_ms gauge
peakees_database_response_time_ms ${dbResponseTime}

# HELP peakees_api_response_time_ms API response time in milliseconds
# TYPE peakees_api_response_time_ms gauge
peakees_api_response_time_ms ${Date.now() - startTime}

# HELP peakees_build_info Build information
# TYPE peakees_build_info gauge
peakees_build_info{version="${process.env.npm_package_version || '1.0.0'}",environment="${process.env.NODE_ENV || 'development'}"} 1
`;

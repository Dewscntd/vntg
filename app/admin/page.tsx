    ...
    const fetchDashboardMetrics = async () => {
      ...
      try {
        ...
        const [productsData, ordersData, usersData, analyticsData] = await Promise.all([
          ...
          usersData.ok ? usersRes.json() : { data: { total: 0 } },
        ...
        const monthlyOrders = ordersData.data?.orders?.filter((o: any) => {
          const orderDate = new Date(o.created_at);
          return orderDate.getMonth() === currentMonth && orderDate.getFullYear() === currentYear;
        }) || [];

        const monthlyRevenue = monthlyOrders.reduce((sum: number, order: any) => sum + order.total, 0);
        const averageOrderValue = ordersData.data?.orders?.length > 0 ?
          (analyticsData.data?.totalRevenue || 0) / ordersData.data.orders.length : 0;
        ...
        const dashboardMetrics: DashboardMetrics = {
          ...
          pendingOrders: ordersData.data?.orders?.filter((o: any) => o.status === 'pending').length || 0,
          lowStockProducts: 5,
          monthlyRevenue,
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center">
                <div className="p-3 rounded-lg bg-green-50 mb-2">
              ...
              <div className="text-center">
                <div className="p-3 rounded-lg bg-blue-50 mb-2">
                  <div className="h-3 w-3 bg-blue-500 rounded-full mx-auto"></div>
                </div>
